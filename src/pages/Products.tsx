...
const Products = () => {
  const productCategories = [
    ...
    },
    {
      ...
      title: "Steel",
      description:
        "A wide range of steel products for structural and general use.",
      items: [
        "I-beams & RSJs",
        "Galvanized pipes",
        "Steel plates & sheets",
    ...
    },
    {
      ...
      description:
        "Everything you need for roofing and cladding projects.",
      items: [
            ...
            <div className="grid items-center gap-10 md:grid-cols-2">
              <div className="space-y-4">
                ...
                <p className="text-xl text-primary-foreground/80 max-w-xl">
                  Quality steel, timber, and roofing materials for builders,
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                A look at some of the timber, steel, and roofing products
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {productPhotos.map((photo) => (
                <div
                  key={photo.alt}
                  className="rounded-xl overflow-hidden bg-primary/5 shadow-lg"
                >
                  <img
                    src={photo.src}
                    alt={photo.alt}
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1 order-2 lg:order-1">
                ...
                <p className="text-muted-foreground mb-6">
                  We offer delivery to Roscrea and surrounding areas. Flexible,
                  reliable, and careful transport of all materials.
                </p>
              ...
              <div className="flex-1 order-1 lg:order-2">
                <div className="bg-primary/10 rounded-2xl overflow-hidden min-h-[300px]">
                  <img
                    src={DeliveryPhoto}
                    alt="Delivery truck"
